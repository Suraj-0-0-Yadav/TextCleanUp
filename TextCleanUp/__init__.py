...
def get_uppercase_word_count(text:str, get_count_and_uppercase_words=False,get_only_uppercase_words=False) -> Union[int, Tuple[int,List[str]], List[str]]:
    """
...
def remove_repeated_chars(text: str) -> str:
    ...
    """
    return utils._remove_repeated_chars(text)

def get_complete_text_clean_up(text: str, 
                                lower_case=True,
